---
description: "Run CaTDD slash command UT_designCatSkeleton"
agent: "agent"
...
- Portable command path: slashCommands/commands/P0-FuncTestsFlow/UT_designCatSkeleton.md
- Default workspace link: [slashCommands/commands/P0-FuncTestsFlow/UT_designCatSkeleton.md](../../slashCommands/commands/P0-FuncTestsFlow/UT_designCatSkeleton.md)
