...
- Portable command path: slashCommands/commands/P0-FuncTestsFlow/UT_convertDemoToTypical.md
- Default workspace link: [slashCommands/commands/P0-FuncTestsFlow/UT_convertDemoToTypical.md](../../slashCommands/commands/P0-FuncTestsFlow/UT_convertDemoToTypical.md)
