...
- Maintain an unbroken **TestPointEvidenceChain**: every test point must trace from source artifact -> rule/invariant -> concrete scenario -> observable oracle -> CaTDD category -> US/AC/TC -> RED/GREEN test.
