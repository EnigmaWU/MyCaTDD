...
- If `CLEARED`: next recommended command is `SPEC_takeArchDesign` when architecture is needed, or `SPEC_takeDetailDesign` when the story can go directly to detailed design.
