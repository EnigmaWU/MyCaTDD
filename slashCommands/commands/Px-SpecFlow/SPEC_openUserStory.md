...
Ask the assistant to preserve story traceability, copy or move only the selected story into shared active work state, start a clear active-work status section, and route the story to `SPEC_makePlan` before design or implementation starts.
