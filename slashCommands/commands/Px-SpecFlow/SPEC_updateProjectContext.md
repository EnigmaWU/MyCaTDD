...
- Updated `.catdd/spec/projectContext.md` team-shared persistent artifact containing compact, confirmed working memory, `## Constitutional Invariants (K)` guardrails, and links to canonical detail.
