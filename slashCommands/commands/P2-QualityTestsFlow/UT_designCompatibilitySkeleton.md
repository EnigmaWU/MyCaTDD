...
Design a CaTDD Compatibility skeleton from project-root `README_DetailDesign.md` and stable behavior.
...
- `detail_design_doc`: required project-root `README_DetailDesign.md` with supported platform, version, protocol, format, toolchain, or integration boundaries.

## Preconditions

- Project-root `README_DetailDesign.md` must exist before drafting the Compatibility skeleton.
- WARNING: If project-root `README_DetailDesign.md` is missing, stop before drafting the Compatibility skeleton and warn the developer.
...
2. If `README_DetailDesign.md` is missing, output a WARNING and stop before drafting the Compatibility skeleton.
3. Read `README_DetailDesign.md` as the compatibility design source, then read existing skeletons for behavior links.
