...
After `SPEC_closeUserStory`, if the work was done on a dedicated story branch, run the repository merge step (for example `SPEC_mergeWork` when available). If no dedicated branch was used, skip merge/integration.
