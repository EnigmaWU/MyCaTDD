...
3. Use [../commands/P2-QualityTestsFlow/UT_designCompatibilitySkeleton.md](../commands/P2-QualityTestsFlow/UT_designCompatibilitySkeleton.md) when project-root `README_DetailDesign.md` exists and version, platform, protocol, format, toolchain, or integration compatibility matters. If `README_DetailDesign.md` is missing, the command warns and stops before drafting the Compatibility skeleton.
