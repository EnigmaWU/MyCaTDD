...
| 8. Implications | ArchDesign owns constraints that shape interfaces and error classes; source/tests own executable detail. VerifyDesign should include tests for budget exhaustion, fallback routing, failure classification, and non-interactive escalation. Threshold values can be revised only through follow-up ADR update. |
...
| 11. Affected Artifacts | [../README_ArchDesign.md](../README_ArchDesign.md), [../README_ArchDesign_ZH.md](../README_ArchDesign_ZH.md), [ADR_ArchitectureOnlyDesignPolicy.md](ADR_ArchitectureOnlyDesignPolicy.md), and module verification/source/tests. |
