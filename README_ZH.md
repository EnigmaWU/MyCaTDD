...
3. [utCodeAgentCLI](codeAgents/utCodeAgentCLI/README.md)（代码智能体）
4. [agentSkills](agentSkills/README.md)（技能包）
...
更多说明：[codeAgents/utCodeAgentCLI/README.md](codeAgents/utCodeAgentCLI/README.md)。当前 CLI 层设计指南见 [codeAgents/utCodeAgentCLI/README_UserGuide_ZH.md](codeAgents/utCodeAgentCLI/README_UserGuide_ZH.md)。

### [4] [agentSkills](agentSkills/README.md)（技能包）

简介：可复用能力封装层。它把 CaTDD 方法知识封装为可触发技能，并保持技能引用与 canonical method files 对齐。

更多说明：[agentSkills/README.md](agentSkills/README.md)。打包和验证步骤见 [agentSkills/README_UserGuide_ZH.md](agentSkills/README_UserGuide_ZH.md)。
...
5. 需要 skill package 层 WHAT/WHY 时，阅读 [agentSkills/README.md](agentSkills/README.md)。
6. 需要生成或验证可复用技能包时，阅读 [agentSkills/README_UserGuide_ZH.md](agentSkills/README_UserGuide_ZH.md)。
7. 需要 CLI agent 层 WHAT/WHY 时，阅读 [codeAgents/utCodeAgentCLI/README.md](codeAgents/utCodeAgentCLI/README.md)。
8. 需要当前 CLI 层设计指南时，阅读 [codeAgents/utCodeAgentCLI/README_UserGuide_ZH.md](codeAgents/utCodeAgentCLI/README_UserGuide_ZH.md)。
