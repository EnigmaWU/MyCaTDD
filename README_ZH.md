...
`slashCommands` 应与具体 code-agent 无关，因此同一套命令材料可被 Copilot、Cline、Continue 或类似助手使用。
...
`utCodeAgentCLI` 是本仓库自己的 CaTDD-native 代码智能体层。它应以 [1] 和 [2] 为基础，再加入更深入的规划与执行，并深度内化 CaTDD。
