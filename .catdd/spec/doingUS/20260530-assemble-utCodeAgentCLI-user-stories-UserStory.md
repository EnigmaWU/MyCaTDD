...
Opened by `/SPEC_openUserStory` on 2026-05-30.
...
- Create or update a UserStories artifact for `utCodeAgentCLI` before any detail design work.
...
- Creating detail design before the UserStories artifact exists.
