...
evolve_harness_command="slashCommands/commands/Px-HarnessKits/HARNESS_evolveHarness.md"
assert_file "$evolve_harness_command"
assert_contains "$evolve_harness_command" "evolution_mode"
assert_contains "$evolve_harness_command" "refine"
assert_contains "$evolve_harness_command" "restructure"
assert_contains "$evolve_harness_command" "success_learning_checkpoint"
assert_contains "$evolve_harness_command" "no reusable learning"
assert_contains "$evolve_harness_command" "## Ownership Router"
assert_contains "$evolve_harness_command" "## Evidence-Grounded Correction Loop"
assert_contains "$evolve_harness_command" "Reason/Propose"
assert_contains "$evolve_harness_command" "Evaluate"
assert_contains "$evolve_harness_command" "Correct or stop"
assert_contains "$evolve_harness_command" "max_correction_attempts"
assert_contains "$evolve_harness_command" "no-progress"
assert_contains "$evolve_harness_command" "same-evidence suppression"
assert_contains "$evolve_harness_command" "Multiple-Lesson Rule"
assert_contains "$evolve_harness_command" "Mode-Specific Mutation Gates"
assert_contains "$evolve_harness_command" "### Worked Example"
[[ ! -e "$REPO_ROOT/slashCommands/commands/Px-HarnessKits/HARNESS_learnFromSuccess.md" ]] || fail "retired HARNESS_learnFromSuccess command must not coexist with HARNESS_evolveHarness"
assert_contains "slashCommands/commands/Px-HarnessKits/README.md" "HARNESS_evolveHarness.md"
assert_contains "slashCommands/kits/Px-HarnessKits.md" "evolution_mode"
assert_contains "slashCommands/kits/Px-HarnessKits.md" "evidence-grounded correction"
assert_contains "slashCommands/README_UserGuide.md" "HARNESS_evolveHarness.md"
...
assert_contains "$impl_product_codes_command" "Bounded Implementation Loop"
