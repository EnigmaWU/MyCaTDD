...
harness_verify_prompt="$TARGET_DIR/.continue/prompts/HARNESS_verifyInstallation.prompt"
[[ -f "$harness_verify_prompt" ]] || fail "missing Continue HARNESS prompt: HARNESS_verifyInstallation.prompt"
