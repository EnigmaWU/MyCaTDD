...
[[ -f "$PACKAGE_DIR/slashCommands/commands/Px-HarnessKits/HARNESS_evolveHarness.md" ]] || fail "missing packaged HARNESS_evolveHarness command"
[[ ! -e "$PACKAGE_DIR/slashCommands/commands/Px-HarnessKits/HARNESS_learnFromSuccess.md" ]] || fail "packaged skill must not contain retired HARNESS_learnFromSuccess command"
